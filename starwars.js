...
// 	const characterIndex = await createCharacterIndex()
    ...
    const filmList = []
    // for in loop that gets film titles stores in array with commas at end of title
        ...
        <div class="child">
          <h1>Character Spotlight<h1>
            <h2>${character.name}</h2>
              ...
              <h3 onClick="renderFilms('${character.films}', '${character.name}')">Films: <span class="bodyText">${films}</span></h3>
